...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Om Babaso Mali!",
    'B.Tech Computer Science student at Walchand College of Engineering.',
    'I enjoy building practical systems, solving problems, and learning new technologies.',
  ],
  skills: () => [
    'Technical Skills:',
    '  Languages:  C, C++, Java (OOP), HTML, CSS',
    '  Coursework: Data Structures, Software Engineering, Computer Networks, OOP',
    '  Soft Skills: Teamwork, Leadership, Critical thinking, Hardworking',
  ],
  projects: () => [
    'Featured Projects:',
    '  1. Stocks Trading System (C++ OOP-based trading platform)',
    '  2. Battery Swap System (full-stack EV battery swap platform)',
    '  3. Anomalyse (fraud detection platform with FastAPI and MySQL)',
    '',
    'Visit the Projects tab for more details.',
  ],
  contact: () => [
    'Contact Information:',
    '  Email:    ommali8421@gmail.com',
    '  Phone:    +91-7038694774',
    '  GitHub:   github.com/Ommali8421',
    '  LinkedIn: linkedin.com/in/om-mali-344837329',
  ],
  themes: () => [
    'Available themes:',
